...
--@localization(locale="frFR", format="lua_additive_table", namespace="VanasKoS/DataGatherer")@
end

L = LibStub("AceLocale-3.0"):NewLocale("VanasKoS/DataGatherer", "deDE")
if L then
-- auto generated from wowace translation app
--@localization(locale="deDE", format="lua_additive_table", namespace="VanasKoS/DataGatherer")@
end

L = LibStub("AceLocale-3.0"):NewLocale("VanasKoS/DataGatherer", "koKR")
if L then
-- auto generated from wowace translation app
--@localization(locale="koKR", format="lua_additive_table", namespace="VanasKoS/DataGatherer")@
end

L = LibStub("AceLocale-3.0"):NewLocale("VanasKoS/DataGatherer", "esMX")
if L then
-- auto generated from wowace translation app
--@localization(locale="esMX", format="lua_additive_table", namespace="VanasKoS/DataGatherer")@
end

L = LibStub("AceLocale-3.0"):NewLocale("VanasKoS/DataGatherer", "ruRU")
if L then
-- auto generated from wowace translation app
--@localization(locale="ruRU", format="lua_additive_table", namespace="VanasKoS/DataGatherer")@
end

L = LibStub("AceLocale-3.0"):NewLocale("VanasKoS/DataGatherer", "zhCN")
if L then
-- auto generated from wowace translation app
--@localization(locale="zhCN", format="lua_additive_table", namespace="VanasKoS/DataGatherer")@
end

L = LibStub("AceLocale-3.0"):NewLocale("VanasKoS/DataGatherer", "esES")
if L then
-- auto generated from wowace translation app
--@localization(locale="esES", format="lua_additive_table", namespace="VanasKoS/DataGatherer")@
end

L = LibStub("AceLocale-3.0"):NewLocale("VanasKoS/DataGatherer", "zhTW")
if L then
-- auto generated from wowace translation app
--@localization(locale="zhTW", format="lua_additive_table", namespace="VanasKoS/DataGatherer")@
end
